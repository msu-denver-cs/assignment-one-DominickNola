...
class FactoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factory" do
    assert_difference('Factory.count') do
      post factories_url, params: { factory: { country: @factory.country, name: @factory.name } }
    end
  ...
  test "should update factory" do
    patch factory_url(@factory), params: { factory: { country: @factory.country, name: @factory.name } }
